<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:72:"D:\wamp64\www\blog\public/../application/admin\view\category\addson.html";i:1511422372;s:61:"D:\wamp64\www\blog\public/../application/admin\view\base.html";i:1511409004;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="utf-8"/>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                <select class="js-example-basic-single form-control" name="cate_pid">
                                    <option value="<?php echo $data['cate_pid']; ?>"><?php echo $data['cate_name']; ?></option>
                                </select>
                            </div>
                        </div>
