<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:68:"D:\wamp64\www\blog\public/../application/admin\view\entry\index.html";i:1511398689;s:61:"D:\wamp64\www\blog\public/../application/admin\view\base.html";i:1511409004;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="utf-8"/>
    ...
    <nav class="navbar navbar-inverse">
        <div class="container-fluid">
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                <h4 style="display: inline;line-height: 50px;float: left;margin: 0px"><a href="index.html" style="color: white;margin-left: -14px">测试陈波博客网</a>
                </h4>
                <div class="navbar-header">
                    <ul class="nav navbar-nav">
                        ...
                        <li>
                            <a href="http://bbs.houdunwang.com" target="_blank"><i class="fa fa-w fa-forumbee"></i> 陈波测试论坛</a>
                        </li>
                    </ul>
                </div>
                <ul class="nav navbar-nav navbar-right">
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu">
                            <li><a href="<?php echo url('admin/entry/modipass'); ?>">修改密码</a></li>
...
<div class="container-fluid admin_menu">
  ...
  <table class="table table-hover">
                ...
                <tr>
                    <td colspan="10">
                        测试官网：<a href="http://www.houdunwang.com" target="_blank">www.houdunwang.com</a>
                        测试论坛：<a href="http://bbs.houdunwang.com" target="_blank">bbs.houdunwang.com</a>
                    </td>
                </tr>
                <tr>
